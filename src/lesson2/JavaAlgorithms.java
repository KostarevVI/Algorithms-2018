...
public class JavaAlgorithms {
    ...
    //Трудоёмкость - O(n)
    //Ресурсоёмкость - O(n)
    //где n - кол-во строк входного файла
    ...
    //Трудоёмкость - O(n^2*m^2*w*l)
    //Ресурсоёмкость - O(n*m+v)
    //где n и m - длинна и ширина матрицы, w - кол-во искомых слов, l - длинна самого длинного искомого слова,
    //v - набор найденных слов
}
